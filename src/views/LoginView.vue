<template>
  ...
  <Form :initial-values="{email:'example@email.com',password:'0123456789'}" @submit="onSubmit" class="bg-gray-50 p-10 rounded shadow-md">
    <div class="flex w-[350px] flex-col items-stretch gap-2 mb-3">
